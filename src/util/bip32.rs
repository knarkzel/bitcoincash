...
impl DerivationPath {
    ...
    ///
    /// ```
    /// use bitcoincash::util::bip32::{DerivationPath, ChildNumber};
    /// use std::str::FromStr;
    ///
...
impl fmt::Display for ExtendedPrivKey {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        ...
        ret[0..4].copy_from_slice(&match self.network {
            ...
            Network::Testnet | Network::Regtest | Network::Testnet4 | Network::Scalenet => [0x04, 0x35, 0x83, 0x94],
        }[..]);
...
impl fmt::Display for ExtendedPubKey {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        ...
        ret[0..4].copy_from_slice(&match self.network {
            ...
            Network::Testnet | Network::Regtest | Network::Testnet4 | Network::Scalenet => [0x04u8, 0x35, 0x87, 0xCF],
        }[..]);
        ret[4] = self.depth as u8;
        ret[5..9].copy_from_slice(&self.parent_fingerprint[..]);
        ret[9..13].copy_from_slice(&endian::u32_to_array_be(u32::from(self.child_number)));
