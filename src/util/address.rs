        ...
        match self.payload {
            Payload::PubkeyHash(ref hash) => {
                ...
                prefixed[0] = match self.network {
                    Network::Bitcoin => 0,
                    Network::Testnet | Network::Regtest | Network::Testnet4 | Network::Scalenet => 111
                };
            ...
            Payload::ScriptHash(ref hash) => {
                ...
                prefixed[0] = match self.network {
                    Network::Bitcoin => 5,
                    Network::Testnet | Network::Regtest | Network::Testnet4 | Network::Scalenet => 196,
                };
                prefixed[1..].copy_from_slice(&hash[..]);
                base58::check_encode_slice_to_fmt(fmt, &prefixed[..])
            }
