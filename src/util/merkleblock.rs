...
//! use bitcoincash::{Block, MerkleBlock};
//!
...
//! let mb: MerkleBlock = bitcoincash::consensus::deserialize(&mb_bytes).unwrap();
//!
...
impl PartialMerkleTree {
    ...
    /// use bitcoincash::hash_types::Txid;
    /// use bitcoincash::hashes::hex::FromHex;
    /// use bitcoincash::util::merkleblock::PartialMerkleTree;
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [
...
impl MerkleBlock {
    ...
    /// let block: Block = bitcoincash::consensus::deserialize(&block_bytes).unwrap();
    ///
