...
use bitcoincash::network::{address, constants, message, message_network};
use bitcoincash::network::stream_reader::StreamReader;
use bitcoincash::secp256k1;
use bitcoincash::secp256k1::rand::Rng;
...
fn main() {
    ...
    let first_message = message::RawNetworkMessage {
        magic: constants::Network::Bitcoin.net_magic(),
