extern crate bitcoincash;

use std::{env, process};
use std::str::FromStr;

use bitcoincash::secp256k1::Secp256k1;
use bitcoincash::util::key::PrivateKey;
use bitcoincash::util::bip32::ExtendedPrivKey;
use bitcoincash::util::bip32::ExtendedPubKey;
use bitcoincash::util::bip32::DerivationPath;
use bitcoincash::util::bip32::ChildNumber;
use bitcoincash::util::address::Address;
